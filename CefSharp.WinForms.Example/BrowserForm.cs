...
namespace CefSharp.WinForms.Example
{
   ...
   {
      private const string DefaultUrlForAddedTabs = "https://www.pamestoixima.gr/EN/1/Live#mode=scoreboard&eventId=4749013&provider=BETGENIUS&sport=FOOTBALL";
      ...
      public BrowserForm(bool multiThreadedMessageLoopEnabled)
      {
         ...
         //WindowState = FormWindowState.Maximizedmax;
         Top = 600;
